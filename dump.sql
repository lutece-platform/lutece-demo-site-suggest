...
-- Dumping structure for table suggest.core_admin_dashboard
...
-- Dumping data for table suggest.core_admin_dashboard: 8 rows
...
-- Dumping structure for table suggest.core_admin_mailinglist
...
-- Dumping data for table suggest.core_admin_mailinglist: 1 rows
...
-- Dumping structure for table suggest.core_admin_mailinglist_filter
...
-- Dumping data for table suggest.core_admin_mailinglist_filter: 1 rows
...
-- Dumping structure for table suggest.core_admin_right
...
-- Dumping data for table suggest.core_admin_right: 34 rows
...
INSERT INTO core_admin_right (id_right, name, level_right, admin_url, description, is_updatable, plugin_name, id_feature_group, icon_url, documentation_url, id_order, is_external_feature) VALUES
	...
	('CORE_CACHE_MANAGEMENT', 'portal.system.adminFeature.cache_management.name', 0, 'jsp/admin/system/ManageCaches.jsp', 'portal.system.adminFeature.cache_management.description', 1, '', 'SYSTEM', 'images/admin/skin/features/manage_caches.png', NULL, 0, 0),
	('CORE_SEARCH_INDEXATION', 'portal.search.adminFeature.indexer.name', 0, 'jsp/admin/search/ManageSearchIndexation.jsp', 'portal.search.adminFeature.indexer.description', 0, '', 'SYSTEM', NULL, NULL, 1, 0),
	('CORE_SEARCH_MANAGEMENT', 'portal.search.adminFeature.search_management.name', 0, NULL, 'portal.search.adminFeature.search_management.description', 0, '', 'SYSTEM', NULL, NULL, 2, 0),
	...
	('CORE_FEATURES_MANAGEMENT', 'portal.admin.adminFeature.features_management.name', 0, NULL, 'portal.admin.adminFeature.features_management.description', 0, '', 'SYSTEM', 'images/admin/skin/features/manage_features.png', NULL, 5, 0),
	...
	('CORE_DAEMONS_MANAGEMENT', 'portal.system.adminFeature.daemons_management.name', 0, 'jsp/admin/system/ManageDaemons.jsp', 'portal.system.adminFeature.daemons_management.description', 0, '', 'SYSTEM', NULL, NULL, 6, 0),
	...
	('CORE_ROLES_MANAGEMENT', 'portal.role.adminFeature.roles_management.name', 2, 'jsp/admin/role/ManagePageRole.jsp', 'portal.role.adminFeature.roles_management.description', 0, '', 'USERS', 'images/admin/skin/features/manage_roles.png', NULL, 0, 0),
	...
	('CORE_ADMINDASHBOARD_MANAGEMENT', 'portal.admindashboard.adminFeature.right_management.name', 0, NULL, 'portal.admindashboard.adminFeature.right_management.description', 0, '', 'SYSTEM', 'images/admin/skin/features/manage_admindashboards.png', NULL, 7, 0),
	('CORE_DASHBOARD_MANAGEMENT', 'portal.dashboard.adminFeature.dashboard_management.name', 0, NULL, 'portal.dashboard.adminFeature.dashboard_management.description', 0, '', 'SYSTEM', 'images/admin/skin/features/manage_dashboards.png', NULL, 8, 0),
	('CORE_XSL_EXPORT_MANAGEMENT', 'portal.xsl.adminFeature.xsl_export_management.name', 2, NULL, 'portal.xsl.adminFeature.xsl_export_management.description', 1, '', 'SYSTEM', NULL, NULL, 9, 0),
	('CORE_TEMPLATES_AUTO_INCLUDES_MANAGEMENT', 'portal.templates.adminFeature.ManageAutoIncludes.name', 1, NULL, 'portal.templates.adminFeature.ManageAutoIncludes.description', 1, '', 'STYLE', 'images/admin/skin/features/manage_templates.png', NULL, 3, 0),
	('CORE_EDITORS_MANAGEMENT', 'portal.admindashboard.editorManagement.right.name', 2, NULL, 'portal.admindashboard.editorManagement.right.description', 1, '', 'SYSTEM', NULL, NULL, 9, 0),
	...
	('MYLUTECE_MANAGE_AUTHENTICATION_FILTER', 'mylutece.adminFeature.mylutece_management_authentication_filter.name', 3, 'jsp/admin/plugins/mylutece/security/ManageAuthenticationFilter.jsp', 'mylutece.adminFeature.mylutece_management_authentication_filter.description', 0, 'mylutece', NULL, NULL, NULL, 8, 0),
	('DATABASE_MANAGEMENT_USERS', 'module.mylutece.database.adminFeature.database_management_user.name', 3, 'jsp/admin/plugins/mylutece/modules/database/ManageUsers.jsp', 'module.mylutece.database.adminFeature.database_management_user.description', 0, 'mylutece-database', NULL, NULL, NULL, 5, 0),
	('DATABASE_GROUPS_MANAGEMENT', 'module.mylutece.database.adminFeature.groups_management.name', 3, 'jsp/admin/plugins/mylutece/modules/database/ManageGroups.jsp', 'module.mylutece.database.adminFeature.groups_management.description', 0, 'mylutece-database', NULL, NULL, NULL, 6, 0),
	('SEO_MANAGEMENT', 'seo.adminFeature.seo_management.name', 0, 'jsp/admin/plugins/seo/ManageSEO.jsp', 'seo.adminFeature.seo_management.description', 0, 'seo', NULL, NULL, NULL, 4, 0),
	...
	('SYSTEMINFO_MANAGEMENT', 'systeminfo.adminFeature.systeminfo_management.name', 0, 'jsp/admin/plugins/systeminfo/ManageSystemInfo.jsp', 'systeminfo.adminFeature.systeminfo_management.description', 0, 'systeminfo', NULL, NULL, NULL, 3, 0),
	('THEME_MANAGEMENT', 'theme.adminFeature.theme_management.name', 0, 'jsp/admin/plugins/theme/ManageThemes.jsp', 'theme.adminFeature.theme_management.description', 0, 'theme', NULL, NULL, 'jsp/admin/documentation/AdminDocumentation.jsp?doc=admin-theme', 4, 0),
	('MYLUTECE_MANAGE_EXTERNAL_APPLICATION', 'mylutece.adminFeature.mylutece_management_external_application.name', 3, 'jsp/admin/plugins/mylutece/ManageExternalApplicationUser.jsp', 'mylutece.adminFeature.mylutece_management_external_application.description', 0, 'mylutece', NULL, NULL, NULL, 7, 0);
/*!40000 ALTER TABLE core_admin_right ENABLE KEYS */;


-- Dumping structure for table suggest.core_admin_role
...
-- Dumping data for table suggest.core_admin_role: 8 rows
...
-- Dumping structure for table suggest.core_admin_role_resource
...
-- Dumping data for table suggest.core_admin_role_resource: 16 rows
...
-- Dumping structure for table suggest.core_admin_user
...
-- Dumping data for table suggest.core_admin_user: 1 rows
...
INSERT INTO core_admin_user (id_user, access_code, last_name, first_name, email, status, password, locale, level_user, reset_password, accessibility_mode, password_max_valid_date, account_max_valid_date, nb_alerts_sent, last_login, workgroup_key) VALUES
	(1, 'admin', 'Admin', 'admin', 'admin@lutece.fr', 0, 'PBKDF2WITHHMACSHA512:40000:4088bd8051df6689d8ad730386915b3d:', 'en', 0, 0, 0, '2020-01-01 00:00:00', 1606483640189, 0, '2019-11-27 14:27:20', 'all');
/*!40000 ALTER TABLE core_admin_user ENABLE KEYS */;


-- Dumping structure for table suggest.core_admin_user_anonymize_field
...
-- Dumping data for table suggest.core_admin_user_anonymize_field: 4 rows
...
-- Dumping structure for table suggest.core_admin_user_field
...
-- Dumping data for table suggest.core_admin_user_field: 0 rows
/*!40000 ALTER TABLE core_admin_user_field DISABLE KEYS */;
/*!40000 ALTER TABLE core_admin_user_field ENABLE KEYS */;


-- Dumping structure for table suggest.core_admin_user_preferences
...
-- Dumping data for table suggest.core_admin_user_preferences: 0 rows
/*!40000 ALTER TABLE core_admin_user_preferences DISABLE KEYS */;
/*!40000 ALTER TABLE core_admin_user_preferences ENABLE KEYS */;


-- Dumping structure for table suggest.core_admin_workgroup
...
-- Dumping data for table suggest.core_admin_workgroup: 0 rows
/*!40000 ALTER TABLE core_admin_workgroup DISABLE KEYS */;
/*!40000 ALTER TABLE core_admin_workgroup ENABLE KEYS */;


-- Dumping structure for table suggest.core_admin_workgroup_user
...
-- Dumping data for table suggest.core_admin_workgroup_user: 0 rows
/*!40000 ALTER TABLE core_admin_workgroup_user DISABLE KEYS */;
/*!40000 ALTER TABLE core_admin_workgroup_user ENABLE KEYS */;


-- Dumping structure for table suggest.core_attribute
...
-- Dumping data for table suggest.core_attribute: 0 rows
/*!40000 ALTER TABLE core_attribute DISABLE KEYS */;
/*!40000 ALTER TABLE core_attribute ENABLE KEYS */;


-- Dumping structure for table suggest.core_attribute_field
...
-- Dumping data for table suggest.core_attribute_field: 0 rows
/*!40000 ALTER TABLE core_attribute_field DISABLE KEYS */;
/*!40000 ALTER TABLE core_attribute_field ENABLE KEYS */;


-- Dumping structure for table suggest.core_connections_log
...
-- Dumping data for table suggest.core_connections_log: 0 rows
/*!40000 ALTER TABLE core_connections_log DISABLE KEYS */;
/*!40000 ALTER TABLE core_connections_log ENABLE KEYS */;


-- Dumping structure for table suggest.core_dashboard
...
-- Dumping data for table suggest.core_dashboard: 4 rows
...
-- Dumping structure for table suggest.core_datastore
...
-- Dumping data for table suggest.core_datastore: 148 rows
...
INSERT INTO core_datastore (entity_key, entity_value) VALUES
	...
	('portal.site.site_property.meta.copyright', 'Copyright &copyright; City of Paris'),
	...
	('portal.site.site_property.home_url', 'jsp/site/Portal.jsp?page=suggest'),
	...
	('portal.site.site_property.back_images', '\'images/admin/skin/bg_images1.jpg\',  \'images/admin/skin/bg_images2.jpg\' , \'images/admin/skin/bg_images3.jpg\''),
	...
	('core.startup.time', '27 nov. 2019 à 14:26:05'),
	...
	('suggest.suggestSubscribersNotificationDaemon.lastRunDate', '1574861195023'),
...
-- Dumping structure for table suggest.core_feature_group
...
-- Dumping data for table suggest.core_feature_group: 7 rows
...
-- Dumping structure for table suggest.core_file
...
-- Dumping data for table suggest.core_file: 4 rows
...
-- Dumping structure for table suggest.core_id_generator
...
-- Dumping data for table suggest.core_id_generator: 0 rows
/*!40000 ALTER TABLE core_id_generator DISABLE KEYS */;
/*!40000 ALTER TABLE core_id_generator ENABLE KEYS */;


-- Dumping structure for table suggest.core_indexer_action
...
-- Dumping data for table suggest.core_indexer_action: 0 rows
/*!40000 ALTER TABLE core_indexer_action DISABLE KEYS */;
/*!40000 ALTER TABLE core_indexer_action ENABLE KEYS */;


-- Dumping structure for table suggest.core_level_right
...
-- Dumping data for table suggest.core_level_right: 4 rows
...
-- Dumping structure for table suggest.core_mail_item
...
-- Dumping data for table suggest.core_mail_item: 0 rows
/*!40000 ALTER TABLE core_mail_item DISABLE KEYS */;
/*!40000 ALTER TABLE core_mail_item ENABLE KEYS */;


-- Dumping structure for table suggest.core_mail_queue
...
-- Dumping data for table suggest.core_mail_queue: 0 rows
/*!40000 ALTER TABLE core_mail_queue DISABLE KEYS */;
/*!40000 ALTER TABLE core_mail_queue ENABLE KEYS */;


-- Dumping structure for table suggest.core_mode
...
-- Dumping data for table suggest.core_mode: 3 rows
...
-- Dumping structure for table suggest.core_page
...
-- Dumping data for table suggest.core_page: 2 rows
...
INSERT INTO core_page (id_page, id_parent, name, description, date_update, status, page_order, id_template, date_creation, role, code_theme, node_status, image_content, mime_type, meta_keywords, meta_description, id_authorization_node, display_date_update, is_manual_date_update) VALUES
	...
	(2, 1, 'Page 1', 'A child page', '2014-06-08 18:23:42', 0, 1, 2, '2014-06-08 18:23:42', 'none', 'default', 1, NULL, 'application/octet-stream', NULL, NULL, 1, 0, 0);
/*!40000 ALTER TABLE core_page ENABLE KEYS */;


-- Dumping structure for table suggest.core_page_template
...
-- Dumping data for table suggest.core_page_template: 6 rows
...
-- Dumping structure for table suggest.core_physical_file
...
-- Dumping data for table suggest.core_physical_file: 4 rows
...
-- Dumping structure for table suggest.core_portal_component
...
-- Dumping data for table suggest.core_portal_component: 9 rows
...
-- Dumping structure for table suggest.core_portlet
...
-- Dumping data for table suggest.core_portlet: 4 rows
...
-- Dumping structure for table suggest.core_portlet_alias
...
-- Dumping data for table suggest.core_portlet_alias: 0 rows
/*!40000 ALTER TABLE core_portlet_alias DISABLE KEYS */;
/*!40000 ALTER TABLE core_portlet_alias ENABLE KEYS */;


-- Dumping structure for table suggest.core_portlet_type
...
-- Dumping data for table suggest.core_portlet_type: 3 rows
...
-- Dumping structure for table suggest.core_role
...
-- Dumping data for table suggest.core_role: 0 rows
/*!40000 ALTER TABLE core_role DISABLE KEYS */;
/*!40000 ALTER TABLE core_role ENABLE KEYS */;


-- Dumping structure for table suggest.core_search_parameter
...
-- Dumping data for table suggest.core_search_parameter: 6 rows
...
-- Dumping structure for table suggest.core_style
...
-- Dumping data for table suggest.core_style: 9 rows
...
-- Dumping structure for table suggest.core_stylesheet
...
-- Dumping data for table suggest.core_stylesheet: 9 rows
...
INSERT INTO core_stylesheet (id_stylesheet, description, file_name, source) VALUES
	...
	(217, 'Plan du site', 'site_map.xsl', _binary ),
...
-- Dumping structure for table suggest.core_style_mode_stylesheet
...
-- Dumping data for table suggest.core_style_mode_stylesheet: 9 rows
...
-- Dumping structure for table suggest.core_template
...
-- Dumping data for table suggest.core_template: 13 rows
...
-- Dumping structure for table suggest.core_text_editor
...
-- Dumping data for table suggest.core_text_editor: 4 rows
...
-- Dumping structure for table suggest.core_user_password_history
...
-- Dumping data for table suggest.core_user_password_history: 0 rows
/*!40000 ALTER TABLE core_user_password_history DISABLE KEYS */;
/*!40000 ALTER TABLE core_user_password_history ENABLE KEYS */;


-- Dumping structure for table suggest.core_user_preferences
...
-- Dumping data for table suggest.core_user_preferences: 0 rows
/*!40000 ALTER TABLE core_user_preferences DISABLE KEYS */;
/*!40000 ALTER TABLE core_user_preferences ENABLE KEYS */;


-- Dumping structure for table suggest.core_user_right
...
-- Dumping data for table suggest.core_user_right: 38 rows
...
-- Dumping structure for table suggest.core_user_role
...
-- Dumping data for table suggest.core_user_role: 15 rows
...
-- Dumping structure for table suggest.core_xsl_export
...
-- Dumping data for table suggest.core_xsl_export: 4 rows
...
-- Dumping structure for table suggest.html_portlet
...
-- Dumping data for table suggest.html_portlet: 4 rows
...
-- Dumping structure for table suggest.mylutece_attribute
...
-- Dumping data for table suggest.mylutece_attribute: 0 rows
/*!40000 ALTER TABLE mylutece_attribute DISABLE KEYS */;
/*!40000 ALTER TABLE mylutece_attribute ENABLE KEYS */;


-- Dumping structure for table suggest.mylutece_attribute_field
...
-- Dumping data for table suggest.mylutece_attribute_field: 0 rows
/*!40000 ALTER TABLE mylutece_attribute_field DISABLE KEYS */;
/*!40000 ALTER TABLE mylutece_attribute_field ENABLE KEYS */;


-- Dumping structure for table suggest.mylutece_connections_log
...
-- Dumping data for table suggest.mylutece_connections_log: 0 rows
/*!40000 ALTER TABLE mylutece_connections_log DISABLE KEYS */;
/*!40000 ALTER TABLE mylutece_connections_log ENABLE KEYS */;


-- Dumping structure for table suggest.mylutece_database_group
...
-- Dumping data for table suggest.mylutece_database_group: 0 rows
/*!40000 ALTER TABLE mylutece_database_group DISABLE KEYS */;
/*!40000 ALTER TABLE mylutece_database_group ENABLE KEYS */;


-- Dumping structure for table suggest.mylutece_database_group_role
...
-- Dumping data for table suggest.mylutece_database_group_role: 0 rows
/*!40000 ALTER TABLE mylutece_database_group_role DISABLE KEYS */;
/*!40000 ALTER TABLE mylutece_database_group_role ENABLE KEYS */;


-- Dumping structure for table suggest.mylutece_database_key
...
-- Dumping data for table suggest.mylutece_database_key: 0 rows
/*!40000 ALTER TABLE mylutece_database_key DISABLE KEYS */;
/*!40000 ALTER TABLE mylutece_database_key ENABLE KEYS */;


-- Dumping structure for table suggest.mylutece_database_user
...
-- Dumping data for table suggest.mylutece_database_user: 0 rows
/*!40000 ALTER TABLE mylutece_database_user DISABLE KEYS */;
/*!40000 ALTER TABLE mylutece_database_user ENABLE KEYS */;


-- Dumping structure for table suggest.mylutece_database_user_group
...
-- Dumping data for table suggest.mylutece_database_user_group: 0 rows
/*!40000 ALTER TABLE mylutece_database_user_group DISABLE KEYS */;
/*!40000 ALTER TABLE mylutece_database_user_group ENABLE KEYS */;


-- Dumping structure for table suggest.mylutece_database_user_parameter
...
-- Dumping data for table suggest.mylutece_database_user_parameter: 38 rows
...
-- Dumping structure for table suggest.mylutece_database_user_password_history
...
-- Dumping data for table suggest.mylutece_database_user_password_history: 0 rows
...
-- Dumping structure for table suggest.mylutece_database_user_role
...
-- Dumping data for table suggest.mylutece_database_user_role: 0 rows
/*!40000 ALTER TABLE mylutece_database_user_role DISABLE KEYS */;
/*!40000 ALTER TABLE mylutece_database_user_role ENABLE KEYS */;


-- Dumping structure for table suggest.mylutece_user_anonymize_field
...
-- Dumping data for table suggest.mylutece_user_anonymize_field: 4 rows
...
-- Dumping structure for table suggest.mylutece_user_field
...
-- Dumping data for table suggest.mylutece_user_field: 0 rows
/*!40000 ALTER TABLE mylutece_user_field DISABLE KEYS */;
/*!40000 ALTER TABLE mylutece_user_field ENABLE KEYS */;


-- Dumping structure for table suggest.seo_friendly_url
...
-- Dumping data for table suggest.seo_friendly_url: 3 rows
...
INSERT INTO seo_friendly_url (id_url, friendly_url, technical_url, date_creation, date_modification, is_canonical, is_sitemap, sitemap_lastmod, sitemap_changefreq, sitemap_priority) VALUES
	(1, '/sitemap.html', '/jsp/site/Portal.jsp?page=map', '2019-11-27 14:24:47', '2012-10-10 00:00:00', 1, 1, '2012-10-10', 'monthly', '0.8'),
	(2, '/contacts.html', '/jsp/site/Portal.jsp?page=contact', '2019-11-27 14:24:47', '2012-10-10 00:00:00', 1, 1, '2012-10-10', 'monthly', '0.8'),
	(3, '/credits.html', '/jsp/site/PopupCredits.jsp', '2019-11-27 14:24:47', '2012-10-10 00:00:00', 1, 1, '2012-10-10', 'monthly', '0.8');
/*!40000 ALTER TABLE seo_friendly_url ENABLE KEYS */;


-- Dumping structure for table suggest.seo_properties
...
-- Dumping data for table suggest.seo_properties: 0 rows
/*!40000 ALTER TABLE seo_properties DISABLE KEYS */;
/*!40000 ALTER TABLE seo_properties ENABLE KEYS */;


-- Dumping structure for table suggest.seo_rule
...
-- Dumping data for table suggest.seo_rule: 3 rows
...
-- Dumping structure for table suggest.subscribe_subscription
...
-- Dumping data for table suggest.subscribe_subscription: 0 rows
/*!40000 ALTER TABLE subscribe_subscription DISABLE KEYS */;
/*!40000 ALTER TABLE subscribe_subscription ENABLE KEYS */;


-- Dumping structure for table suggest.suggest_action
...
-- Dumping data for table suggest.suggest_action: 11 rows
...
INSERT INTO suggest_action (id_action, name_key, description_key, action_url, icon_url, action_permission, suggest_state) VALUES
	(1, 'suggest.action.modify.name', 'suggest.action.modify.description', 'jsp/admin/plugins/suggest/ModifySuggest.jsp', 'icon-edit icon-white', 'MODIFY', 0),
	(2, 'suggest.action.modify.name', 'suggest.action.modify.description', 'jsp/admin/plugins/suggest/ModifySuggest.jsp', 'icon-edit icon-white', 'MODIFY', 1),
	(3, 'suggest.action.manageSuggestSubmit.name', 'suggest.action.manageSuggestSubmit.description', 'jsp/admin/plugins/suggest/ManageSuggestSubmit.jsp', 'icon-inbox icon-white', 'MANAGE_SUGGEST_SUBMIT', 0),
	(4, 'suggest.action.manageSuggestSubmit.name', 'suggest.action.manageSuggestSubmit.description', 'jsp/admin/plugins/suggest/ManageSuggestSubmit.jsp', 'icon-inbox icon-white', 'MANAGE_SUGGEST_SUBMIT', 1),
	(5, 'suggest.action.disable.name', 'suggest.action.disable.description', 'jsp/admin/plugins/suggest/ConfirmDisableSuggest.jsp', 'icon-remove icon-white', 'CHANGE_STATE', 1),
	(6, 'suggest.action.enable.name', 'suggest.action.enable.description', 'jsp/admin/plugins/suggest/DoEnableSuggest.jsp', 'icon-ok icon-white', 'CHANGE_STATE', 0),
	(7, 'suggest.action.copy.name', 'suggest.action.copy.description', 'jsp/admin/plugins/suggest/DoCopySuggest.jsp', 'icon-move icon-white', 'COPY', 0),
	(8, 'suggest.action.copy.name', 'suggest.action.copy.description', 'jsp/admin/plugins/suggest/DoCopySuggest.jsp', 'icon-move icon-white', 'COPY', 1),
	(9, 'suggest.action.delete.name', 'suggest.action.delete.description', 'jsp/admin/plugins/suggest/ConfirmRemoveSuggest.jsp', 'icon-trash icon-white', 'DELETE', 0),
	(10, 'suggest.action.updateAllSuggestSubmit.name', 'suggest.action.updateAllSuggestSubmit.description', 'jsp/admin/plugins/suggest/ConfirmUpdateAllSuggestSubmit.jsp', 'icon-cog icon-white', 'UPDATE_ALL_SUGGEST_SUBMIT', 1),
	(11, 'suggest.action.updateAllSuggestSubmit.name', 'suggest.action.updateAllSuggestSubmit.description', 'jsp/admin/plugins/suggest/ConfirmUpdateAllSuggestSubmit.jsp', 'icon-cog icon-white', 'UPDATE_ALL_SUGGEST_SUBMIT', 0);
/*!40000 ALTER TABLE suggest_action ENABLE KEYS */;


-- Dumping structure for table suggest.suggest_category
...
-- Dumping data for table suggest.suggest_category: 2 rows
...
-- Dumping structure for table suggest.suggest_comment_submit
...
-- Dumping data for table suggest.suggest_comment_submit: 0 rows
/*!40000 ALTER TABLE suggest_comment_submit DISABLE KEYS */;
/*!40000 ALTER TABLE suggest_comment_submit ENABLE KEYS */;


-- Dumping structure for table suggest.suggest_default_message
...
-- Dumping data for table suggest.suggest_default_message: 1 rows
...
-- Dumping structure for table suggest.suggest_entry
...
-- Dumping data for table suggest.suggest_entry: 1 rows
...
INSERT INTO suggest_entry (id_entry, id_suggest, id_type, title, help_message, entry_comment, mandatory, pos, default_value, height, width, max_size_enter, show_in_suggest_submit_list) VALUES
	(1, 1, 3, 'Your proposal', 'Saisir votre proposition', '', 1, 1, '', 5, 57, -1, 1);
/*!40000 ALTER TABLE suggest_entry ENABLE KEYS */;


-- Dumping structure for table suggest.suggest_entry_attr_additional
...
-- Dumping data for table suggest.suggest_entry_attr_additional: 0 rows
/*!40000 ALTER TABLE suggest_entry_attr_additional DISABLE KEYS */;
/*!40000 ALTER TABLE suggest_entry_attr_additional ENABLE KEYS */;


-- Dumping structure for table suggest.suggest_entry_type
...
-- Dumping data for table suggest.suggest_entry_type: 6 rows
...
INSERT INTO suggest_entry_type (id_type, title, class_name) VALUES
	...
	(2, 'Zone de texte court', 'fr.paris.lutece.plugins.suggest.business.EntryTypeText'),
	(3, 'Zone de texte long', 'fr.paris.lutece.plugins.suggest.business.EntryTypeTextArea'),
	...
	(6, 'Editeur bbcode', 'fr.paris.lutece.plugins.suggest.business.EntryTypeEditorBbcode');
/*!40000 ALTER TABLE suggest_entry_type ENABLE KEYS */;


-- Dumping structure for table suggest.suggest_entry_verify_by
...
-- Dumping data for table suggest.suggest_entry_verify_by: 0 rows
/*!40000 ALTER TABLE suggest_entry_verify_by DISABLE KEYS */;
/*!40000 ALTER TABLE suggest_entry_verify_by ENABLE KEYS */;


-- Dumping structure for table suggest.suggest_export_format
...
-- Dumping data for table suggest.suggest_export_format: 3 rows
...
INSERT INTO suggest_export_format (id_export, title, description, extension, xsl_file) VALUES
	(1, 'xml', 'Export proposals in xml format', 'xml', _binary ),
	(2, 'csv propositions', 'Export proposals in csv format', 'csv', _binary ),
	(3, 'csv commentaires', 'Export comments in csv format', 'csv', _binary );
/*!40000 ALTER TABLE suggest_export_format ENABLE KEYS */;


-- Dumping structure for table suggest.suggest_image
...
-- Dumping data for table suggest.suggest_image: 2 rows
...
-- Dumping structure for table suggest.suggest_reported_message
...
-- Dumping data for table suggest.suggest_reported_message: 0 rows
/*!40000 ALTER TABLE suggest_reported_message DISABLE KEYS */;
/*!40000 ALTER TABLE suggest_reported_message ENABLE KEYS */;


-- Dumping structure for table suggest.suggest_response
...
-- Dumping data for table suggest.suggest_response: 1 rows
...
INSERT INTO suggest_response (id_response, id_suggest_submit, response_value, id_entry, id_resource_image) VALUES
	(1, 1, 'Add consultation statistics', 1, NULL);
/*!40000 ALTER TABLE suggest_response ENABLE KEYS */;


-- Dumping structure for table suggest.suggest_rss_cf
...
-- Dumping data for table suggest.suggest_rss_cf: 0 rows
/*!40000 ALTER TABLE suggest_rss_cf DISABLE KEYS */;
/*!40000 ALTER TABLE suggest_rss_cf ENABLE KEYS */;


-- Dumping structure for table suggest.suggest_suggest
...
-- Dumping data for table suggest.suggest_suggest: 1 rows
...
INSERT INTO suggest_suggest (id_suggest, title, unavailability_message, workgroup, id_vote_type, number_vote_required, number_day_required, active_suggest_submit_authentification, active_vote_authentification, active_comment_authentification, disable_new_suggest_submit, authorized_comment, disable_new_comment, id_mailing_list_suggest_submit, active_captcha, active, date_creation, libelle_validate_button, active_suggest_proposition_state, libelle_contribution, number_suggest_submit_in_top_score, number_suggest_submit_in_top_comment, limit_number_vote, number_suggest_submit_caracters_shown, show_category_block, show_top_score_block, show_top_comment_block, active_suggest_submit_paginator, number_suggest_submit_per_page, role, enable_new_suggest_submit_mail, header, sort_field, sort_asc, code_theme, confirmation_message, active_editor_bbcode, default_suggest, id_default_sort, notification_new_comment_sender, notification_new_comment_title, notification_new_comment_body, notification_new_suggest_submit_sender, notification_new_suggest_submit_title, notification_new_suggest_submit_body) VALUES
	(1, 'Idea box', 'This suggest is unavailable', 'all', 2, -1, -1, 0, 0, 0, 0, 1, 0, -1, 0, 1, '2009-05-13 22:24:07', 'Validate', 0, 'Your suggestions for improvement', 10, 10, 0, 500, 1, 1, 1, 0, -1, NULL, 0, NULL, 0, 0, NULL, NULL, 0, 0, NULL, NULL, '#i18n{suggest.notifications.newComment.title}', '<html>\r\n	<head>\r\n		<link href="${base_url}css/bootstrap.min.css" rel="stylesheet"/>\r\n	</head>\r\n	<body>\r\n		<p>#i18n{suggest.notifications.newComment.hello}</p>\r\n		<br />\r\n		${comments?size} #i18n{suggest.notifications.newComment.newCommentsPosted} :\r\n		<br />\r\n		<#list comments as comment_submit>\r\n			<p>\r\n				<#if comment_submit.isOfficialAnswer()>\r\n					<span class="badge badge-warning">\r\n						<i class="icon-star icon-white"></i> \r\n						#i18n{suggest.manageCommentSubmit.officialAnswer}\r\n					</span>\r\n					&nbsp;\r\n				</#if>\r\n				<i class="icon-calendar"></i> ${comment_submit.dateComment?string("dd/MM/yyyy HH:mm:ss")}\r\n			</p>\r\n			<#if comment_submit.value?length &gt; 100>\r\n				${comment_submit.value?substring(0,100)}\r\n			<#else>\r\n				${comment_submit.value}\r\n			</#if>\r\n			<a class="btn btn-small btn-primary" href="${base_url}/jsp/site/Portal.jsp?page=suggest&id_suggest=${comment_submit.suggestSubmit.suggest.idSuggest}&id_suggest_submit=${comment_submit.suggestSubmit.idSuggestSubmit}&action=view_suggest_submit">\r\n				#i18n{suggest.suggestListSubmit.labelReadMore}\r\n			</a>\r\n			<br />\r\n			<br />\r\n		</#list>\r\n	</body>\r\n</html>', NULL, '#i18n{suggest.notifications.newSuggestSubmit.title}', '<html>\r\n	<head>\r\n		<link href="${base_url}css/bootstrap.min.css" rel="stylesheet"/>\r\n	</head>\r\n	<body>\r\n		<p>#i18n{suggest.notifications.newSuggestSubmit.hello}</p>\r\n		<br />\r\n		${suggestSubmits?size} #i18n{suggest.notifications.newSuggestSubmit.newSuggestSubmitPosted} :\r\n		<br />\r\n		<#list suggestSubmits as suggestSubmit>\r\n			<p>\r\n				${suggestSubmit.suggestSubmitTitle}\r\n			</p>\r\n			<a class="btn btn-small btn-primary" href="${base_url}/jsp/site/Portal.jsp?page=suggest&id_suggest=${suggestSubmit.suggest.idSuggest}&id_suggest_submit=${suggestSubmit.idSuggestSubmit}&action=view_suggest_submit">\r\n				#i18n{suggest.suggestListSubmit.labelReadMore}\r\n			</a>\r\n			<br />\r\n			<br />\r\n		</#list>\r\n	</body>\r\n</html>');
/*!40000 ALTER TABLE suggest_suggest ENABLE KEYS */;


-- Dumping structure for table suggest.suggest_suggest_attribute
...
-- Dumping data for table suggest.suggest_suggest_attribute: 0 rows
/*!40000 ALTER TABLE suggest_suggest_attribute DISABLE KEYS */;
/*!40000 ALTER TABLE suggest_suggest_attribute ENABLE KEYS */;


-- Dumping structure for table suggest.suggest_suggest_category
...
-- Dumping data for table suggest.suggest_suggest_category: 0 rows
/*!40000 ALTER TABLE suggest_suggest_category DISABLE KEYS */;
/*!40000 ALTER TABLE suggest_suggest_category ENABLE KEYS */;


-- Dumping structure for table suggest.suggest_suggest_submit
...
-- Dumping data for table suggest.suggest_suggest_submit: 1 rows
...
INSERT INTO suggest_suggest_submit (id_suggest_submit, id_suggest, id_state, user_login, date_response, vote_number, score_number, id_category, suggest_submit_value, suggest_submit_title, comment_enable_number, suggest_submit_value_show_in_the_list, reported, lutece_user_key, suggest_submit_list_order, suggest_submit_type, number_view, disable_vote, is_pinned, disable_comment, id_image_resource, comment_number) VALUES
	(1, 1, 3, NULL, '2009-05-13 22:39:40', 13, 26, NULL, '	<div class="response-element-title"> \r\n Add consultation statistics\r\n	</div>	\r\n\r\n', 'Add consultation statistics', 0, '	<div class="response-element-title"> \r\n Add consultation statistics\r\n	</div>	\r\n\r\n', 0, NULL, 0, 0, 0, 0, 0, 0, NULL, 0);
/*!40000 ALTER TABLE suggest_suggest_submit ENABLE KEYS */;


-- Dumping structure for table suggest.suggest_suggest_submit_state
...
-- Dumping data for table suggest.suggest_suggest_submit_state: 3 rows
...
-- Dumping structure for table suggest.suggest_suggest_submit_type
...
-- Dumping data for table suggest.suggest_suggest_submit_type: 3 rows
...
INSERT INTO suggest_suggest_submit_type (id_type, name, color, id_resource_image, parameterizable, id_xsl) VALUES
	(1, 'Anounce', '#CCFFFF', 1, 1, 0),
	(2, 'Post It', '#FFFF66', 2, 1, 0),
	(3, 'Normal', '#FFFFFF', NULL, 1, 0);
/*!40000 ALTER TABLE suggest_suggest_submit_type ENABLE KEYS */;


-- Dumping structure for table suggest.suggest_suggest_suggest_submit_type
...
-- Dumping data for table suggest.suggest_suggest_suggest_submit_type: 0 rows
...
-- Dumping structure for table suggest.suggest_suggest_user_info
...
-- Dumping data for table suggest.suggest_suggest_user_info: 0 rows
/*!40000 ALTER TABLE suggest_suggest_user_info DISABLE KEYS */;
/*!40000 ALTER TABLE suggest_suggest_user_info ENABLE KEYS */;


-- Dumping structure for table suggest.suggest_video
...
-- Dumping data for table suggest.suggest_vote_button: 0 rows
/*!40000 ALTER TABLE suggest_vote_button DISABLE KEYS */;
/*!40000 ALTER TABLE suggest_vote_button ENABLE KEYS */;


-- Dumping structure for table suggest.suggest_vote_type
...
-- Dumping data for table suggest.suggest_vote_type: 2 rows
...
-- Dumping structure for table suggest.suggest_vote_type_vote_button
...
-- Dumping data for table suggest.theme_global: 1 rows
...
-- Dumping structure for table suggest.theme_theme
...
-- Dumping data for table suggest.theme_theme: 10 rows
